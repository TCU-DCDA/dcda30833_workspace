...
-   Concrete poetry (Gomringer, de Campos) --- [UbuWeb: *Concrete Poetry, A World View*](https://www.ubu.com/papers/solt/brazil.html) and a [movement overview at The Art Story](https://www.theartstory.org/movement/concrete-poetry/); see also our own [kinetic *Silencio* recreation](../sketches/concrete_poem.html)
